...
builder.Services.AddSingleton<IEmployeeStatsRepository, EmployeeStatsRepository>();
builder.Services.AddSingleton<IEmployeeStatsService, EmployeeStatsService>();
builder.Services.AddSingleton<IEmployeesCacheRepository, EmployeesCacheRepository>();
